// ============================================================
// assets/js/auth.js
// نظام المصادقة الكامل - دعم تسجيل الدخول والتسجيل
// ============================================================
...
onAuthStateChanged(auth, async (user) => {
  ...
  console.log("🔐 Auth state changed:", user ? "Logged in" : "Logged out", "Path:", currentPath);
...
console.log("✅ مداد العلم - Auth Module Loaded (Firebase v10)");
